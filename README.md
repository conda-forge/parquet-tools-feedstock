...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/parquet-tools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13668&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/parquet-tools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `parquet-tools` can be installed with:

```
conda install parquet-tools
```

It is possible to list all of the versions of `parquet-tools` available on your platform with:
